  ...
  comparison: {
    ...
    rows: [
      ...
      },
      {
        ...
        precision: "Best of the set — capacity *and* live load",
        memory: "O(N) counters + weights",
  ...
  howToChoose: [
    { type: "h", text: "Decision guide" },
    {
      ...
      items: [
        ...
        "**Both at once — mixed fleet *and* variable request cost** → **Weighted Least Connections**. It divides live load by capacity, the most adaptive of the stateless-to-state-aware ladder.",
      ],
    },
    {
      type: "callout",
