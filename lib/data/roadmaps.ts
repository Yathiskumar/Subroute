      ...
      },
      {
        ...
        groups: [
          ...
          },
          {
            label: "Behavioral",
            items: [
              { title: "Chain of Responsibility", note: "Pass a request along a chain of handlers.", slug: "chain-of-responsibility" },
              { title: "Command", note: "Wrap an action as an object you can queue or undo.", slug: "command" },
              { title: "Iterator", note: "Traverse a collection without exposing its internals.", slug: "iterator" },
              { title: "Mediator", note: "Centralize tangled object-to-object communication.", slug: "mediator" },
              { title: "Memento", note: "Capture and restore an object's state.", slug: "memento" },
              { title: "Observer", note: "Notify dependents automatically when state changes.", tag: "interview", slug: "observer" },
              { title: "State", note: "Change behavior when the internal state changes.", slug: "state" },
              { title: "Strategy", note: "Swap interchangeable algorithms at runtime.", tag: "interview", slug: "strategy" },
              { title: "Template Method", note: "Fix the skeleton, let subclasses fill the steps.", slug: "template-method" },
              { title: "Visitor", note: "Add operations to a hierarchy without touching it.", slug: "visitor" },
              { title: "Null Object", note: "A do-nothing default that removes null checks.", slug: "null-object" },
            ],
          },
          {
            label: "Architectural",
            ...
            items: [
              {
                ...
                note: "Scheduling and request dispatch.",
                tag: "interview",
                slug: "elevator-system",
              },
              {
                title: "Library Management",
                note: "Catalog, members, and loans.",
                tag: "interview",
                slug: "library-management",
              },
              {
                title: "Logging framework",
                note: "Levels, appenders, and formatting.",
                tag: "interview",
                slug: "logging-framework",
              },
              {
                title: "Rate Limiter",
                note: "Token bucket and sliding windows.",
                tag: "interview",
                slug: "rate-limiter",
              },
              {
                title: "Notification system",
                note: "Channels, templates, and routing.",
                tag: "interview",
                slug: "notification-system",
              },
              {
                title: "Cache (LRU / LFU)",
                note: "Eviction policy behind a clean API.",
                tag: "interview",
                slug: "lru-lfu-cache",
              },
              {
                title: "Splitwise",
                note: "Expenses, balances, and settlements.",
                tag: "interview",
                slug: "splitwise",
              },
              {
                title: "Meeting room scheduler",
                note: "Intervals, conflicts, and booking.",
                tag: "interview",
                slug: "meeting-room-scheduler",
              },
              {
                title: "In-memory key-value store",
                note: "Get/set with TTL and eviction.",
                tag: "interview",
